...
void Fonseca_Fleming_Function(Population *p, int n) {
    ...
    */
    ...
    sum_1 = " -( x_0 - (1/sqrt(3)) )^2 - ( x_1 - (1/sqrt(3)) )^2 - ( x_2 - (1/sqrt(3)) )^2 ";
    sum_2 = " -( x_0 + (1/sqrt(3)) )^2 - ( x_1 + (1/sqrt(3)) )^2 - ( x_2 + (1/sqrt(3)) )^2 ";
...
void Population_Set_Zitzler_Deb_Thieles_Function(Population *P) {
