...
public:
    ...
    void Population_Initialization(VARIABLE_TYPE min, VARIABLE_TYPE max);

    vector<VARIABLE_TYPE> Get_Search_Domain_MIN() {

        return Search_Domain_MIN;
    }

    vector<VARIABLE_TYPE> Get_Search_Domain_MAX() {

        return Search_Domain_MAX;
    }
